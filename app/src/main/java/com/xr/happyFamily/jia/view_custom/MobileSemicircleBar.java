 ...
 */
public class MobileSemicircleBar extends View {
    ...
    public MobileSemicircleBar(Context context) {
        this(context, null);
    }

    public MobileSemicircleBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MobileSemicircleBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            canvas.drawCircle(centerX, centerY, wheelRadius, mWheelPaint);
            canvas.drawArc(new RectF(left, top, right, bottom), 135, (float) 270, false, mWheelPaint);
            //画锚点
            ...
            for (int i = 0; i < 72; i++) {
                ...
                canvas.drawRect(centerX - TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, getResources().getDisplayMetrics()),
                        getPaddingTop() + mReachedWidth + TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getResources().getDisplayMetrics()),
                        centerX + TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics()),

                        getPaddingTop() + mReachedWidth + TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -5, getResources().getDisplayMetrics()), mPaint);
...
//        for (int i = 0; i < 72; i++) {
//            if (i > 27 && i <45) {
//                mPaint.setColor(getResources().getColor(R.color.green2));
//            } else {
//                mPaint.setColor(getResources().getColor(R.color.color_blue));
//            }
//            canvas.drawRect(centerX - TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, getResources().getDisplayMetrics()),
//                    getPaddingTop() + mReachedWidth + TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics()),
//                    centerX + TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics()),
//
//                    getPaddingTop() + mReachedWidth + TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()), mPaint);
//            canvas.rotate(5, centerX, centerY);
//        }
        //画锚点
//        mPointerPaint.setColor(getResources().getColor(R.color.color_black3));
...
//            strs = new String[]{"5", "10", "15", "20", "25", "30", "35","40"};//绘制数字1-12  (数字角度不对  可以进行相关的处理)
...
//        return Math.round(mMaxProcess * ((float) mCurAngle / 360));
    ...
    public interface OnSeekBarChangeListener {
        void onChanged(MobileSemicircleBar seekbar, double curValue);
    }
}