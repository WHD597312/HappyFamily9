...
public class Timepicker1 extends NumberPicker {
    public Timepicker1(Context context, AttributeSet attrs,
                       int defStyleAttr) {
    ...
    public void setNumberPicker(View view) {
        if (view instanceof EditText) {
            ((EditText) view).setTextColor(this.getResources().getColor(R.color.color_blue_yuan));
