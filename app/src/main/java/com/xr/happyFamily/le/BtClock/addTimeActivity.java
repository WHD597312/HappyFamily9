...
public class addTimeActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rl_add_day)
    RelativeLayout rl_add_day;
    @BindView(R.id.tv_lesd_week)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_le_sdcomonclock);
...
//        timepicker2.setBackgroundColor(Color.WHITE);
    ...
    @OnClick({R.id.rl_add_day, R.id.tv_lrsd_qx, R.id.tv_lrsd_qd})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.rl_add_day:
                initPopup();
                break;
