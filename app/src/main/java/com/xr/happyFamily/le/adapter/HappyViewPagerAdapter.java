...
public class HappyViewPagerAdapter extends PagerAdapter {
    private List<ImageView> images;
    private ViewPager viewPager;
    private Context mContext;
    List<HappyBannerBean> happyBannerBeans = new ArrayList<>();
    ...
    public HappyViewPagerAdapter(Context context, List<ImageView> images, ViewPager viewPager, List<HappyBannerBean> happyBannerBeans) {
        mContext = context;
        this.happyBannerBeans = happyBannerBeans;
        this.images = images;
...
//        } else {
            if(parent!=null){
                ...
                iv = new ImageView(mContext);
//                iv.setBackgroundResource(imageRess[i]);//设置图片
                Picasso.with(mContext).load(happyBannerBeans.get(position % images.size()).getPicUrl()).into(iv);
