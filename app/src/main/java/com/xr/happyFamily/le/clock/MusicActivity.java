...
public class MusicActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clock_music);
        ...
        adapter = new ChooseRingAdapter(MusicActivity.this,mData);
        ...
        switch (requestCode) {
            ...
            case ALARM_RINGTONE_PICKED:{
                ...
                if(null == pickedUri){
                    ...
                    Ringtone ringtone =  RingtoneManager.getRingtone(MusicActivity.this, pickedUri);
                    String strRingtone = ringtone.getTitle(MusicActivity.this);
