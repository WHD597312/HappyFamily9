...
public class JyTimepicker extends NumberPicker {



    public JyTimepicker(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        a.recycle();
    ...
    public JyTimepicker(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public JyTimepicker(Context context) {
        super(context);
