...
public class QunzuTimepicker extends NumberPicker {



    public QunzuTimepicker(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        a.recycle();
    ...
    public QunzuTimepicker(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public QunzuTimepicker(Context context) {
        super(context);
...
//              int color=mColor;
            ...
            int color=   Color.parseColor("#3682ff");
