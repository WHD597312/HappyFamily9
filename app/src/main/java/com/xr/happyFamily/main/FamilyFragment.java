...
public class FamilyFragment  extends Fragment{
    ...
    @BindView(R.id.gv_share_view) MyGridview gv_share_view;/**分享设备*/
    ...
    private int userId;
    private GridViewAdapter mGridViewAdapter;/**常用设备适配器*/
    private GridViewAdapter shareViewAdapter;/**分享设备适配器*/
